...
function generatePathSegments(): PathSegment[] {
  ...
  // ②右外弧段：沿上半小圆右侧外轮廓顺时针走平滑弧线到A点
  const rightArcSteps = 9;
