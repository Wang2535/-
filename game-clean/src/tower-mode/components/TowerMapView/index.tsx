    ...
    return (
      <div className="tower-map-container" style={{ 
        ...
        <div className="main-area">
          <div className="map-container" ref={mapContainerRef} style={{ position: 'relative', zIndex: 1, width: '100%', height: '100%', display: 'flex', justifyContent: 'center', alignItems: 'center', opacity: 1 }}>
